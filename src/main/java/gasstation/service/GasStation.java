...
public interface GasStation {
	 ...
	 *            the gas pump
	 */
	void addGasPump(GasPump pump) throws NotFoundException;
	 ...
	 */
	double buyGas(GasType type, double amountInLiters, double maxPricePerLiter) throws NotEnoughGasException, GasTooExpensiveException, NotFoundException;
	 ...
	 */
	double getPrice(GasType type) throws NotFoundException;
	 ...
	 */
	void setPrice(GasType type, double price) throws NotFoundException;
